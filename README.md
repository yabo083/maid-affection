<p align="center">
  <img src="https://github.com/user-attachments/assets/placeholder-kiss-maid.gif" alt="Kiss your maid!" width="600"/>
</p>
...
> ⚠️ **GIF/截图占位**：上方图片为占位符。请在游戏中截取亲吻女仆时的 GIF 动图或截图后，替换 `src` 链接。
>
> 推荐使用 [ScreenToGif](https://www.screentogif.com/) 或 [ShareX](https://getsharex.com/) 录制。
